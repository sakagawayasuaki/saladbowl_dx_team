...
cursor.execute("DROP TABLE IF EXISTS user_tmp;")
print("Finished dropping table (if existed).")
# cursor.execute("DROP TABLE IF EXISTS deal3;")
# print("Finished dropping table (if existed).")
# cursor.execute("DROP TABLE IF EXISTS user;")
# print("Finished dropping table (if existed).")
# cursor.execute("DROP TABLE IF EXISTS user3;")
# print("Finished dropping table (if existed).")
...
# # 新規取引明細 テーブル作成 
# # Drop previous table of same name if one exists
# cursor.execute("DROP TABLE IF EXISTS deal_detail_2;")
# print("Finished dropping table (if existed).")

# # Create table
# cursor.execute('''
#   CREATE TABLE deal_detail_2 (
#       trd_id INT,
